...
class UpdateSubscriptionStatusTest extends CustomDuskTestCase
{
    /**
     ...
     * @return void
     */
    public function test_can_update_subscription_status(): void
    {
        ...
        $this->browse(function (Browser $browser) {
            ...
            $browser
                        ...
                        ->select('#update_'.$id, 2)
                        ->press('SAVE')
                        ->assertDialogOpened('Are you sure to change subscription status?')
                        ->acceptDialog()
                        ->pause(2000)
                        ->waitForDialog()
                        ->acceptDialog()
                        ->assertPathIs('/customers/*')
                        ->assertValue('#update_'.$id, 2);
        });
    }
}
